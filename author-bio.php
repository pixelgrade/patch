...
<aside class="author-info  media" itemscope itemtype="http://schema.org/Person">
	...
	<div class="author-info__description  media__body">
		...
		<a class="author-info__link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author" title="<?php printf( __( 'View all posts by %s', 'patch' ), get_the_author() ); ?>"><?php _e( 'All posts', 'patch' ); ?></a>
