...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		wp_nav_menu( array(
			...
			'items_wrap'         => '<nav class="footer-menu"><h5 class="screen-reader-text">'. esc_html__( 'Footer navigation', 'patch' ).'</h5><ul id="%1$s" class="%2$s">%3$s</ul></nav>',
			'depth'          => 1,
			'fallback_cb'    => '',
		) ); ?>
	</footer><!-- #colophon -->
...
<div class="mobile-header">
	<div class="mobile-header-wrapper">
		<button class="navigation__trigger  js-nav-trigger">
			<i class="fa fa-bars"></i><span class="screen-reader-text"><?php esc_html_e( 'Menu', 'patch' ); ?></span>
		</button>
