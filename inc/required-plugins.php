...
function patch_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			'notice_can_install_required'     => _n_noop( 'Patch requires the following plugin: %1$s.', 'Patch requires the following plugins: %1$s.', '__theme_txtd' ),
			/* translators: %1$s = plugin name */
			'notice_can_install_recommended'  => _n_noop( 'Patch recommends the following plugin: %1$s.', 'Patch recommends the following plugins: %1$s.', '__theme_txtd' ),
			// %1$s = plugin name(s)
