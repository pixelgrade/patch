 ...
 */
function patch_setup_pixelgrade_care() {
	/*
...
add_action( 'after_setup_theme', 'patch_setup_pixelgrade_care', 10 );

function patch_hide_pixelgrade_care_menu_item() {
	?>
	<style>
...
add_action( 'admin_footer', 'patch_hide_pixelgrade_care_menu_item', 10 );
...
function patch_pixcare_install_page() {
	 ...
	 */
	$admin_title = apply_filters( 'admin_title', esc_html__( 'Pixelgrade Care &rsaquo; Installer', '__theme_txtd' ), '' );
